...
public class FunFactsMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //diplay funfact in a recyclerview
        setContentView(R.layout.activity_funfacts_recyclerview);

        //input funfact data into a list
        funfacts = new ArrayList<>();
        funfacts.add(new FunFacts("1. Mars and Earth have approximately the same landmass","Even though" +
        ...
        funfacts.add(new FunFacts("2. Mars is home to the tallest mountain in the solar system","Olympus Mons, a shield volcano," +
        ...
        funfacts.add(new FunFacts("3. Only 18 missions to Mars have been successful","As of September 2014, there have been 40 missions to Mars," +
        ...
        funfacts.add(new FunFacts("4. Mars has the largest dust storms in the solar system","They can last for months and cover the entire planet. " +
        ...
        funfacts.add(new FunFacts("5. On Mars the Sun appears around half the size as it does on Earth","At the closest point to the Sun, the Martian southern hemisphere leans towards the Sun, " +
        ...
        funfacts.add(new FunFacts("6. Pieces of Mars have fallen to Earth","Scientists have found tiny traces of Martian atmosphere within meteorites violently ejected from Mars, then orbiting the solar system amongst galactic" +
        ...
        funfacts.add(new FunFacts("7. Mars takes its name from the Roman god of war","The ancient Greeks called the planet Ares, after their god of war; the Romans then did, likewise, associating the planet’s blood-red colour " +
        ...
        funfacts.add(new FunFacts("8. There are signs of liquid water on Mars","For years Mars has been known to have water in the form of ice. The first signs of trickling water are dark stripes or stains on crater wall and cliffs seen in satellite images." +
                " Due to Mars’ atmosphere this water would have to be salty to prevent it from freezing or vaporising.",R.drawable.funfact8));
        funfacts.add(new FunFacts("10. One day Mars will have a ring","In the next 20-40 million years Mars’ largest moon Phobos will be torn apart by gravitational forces leading to the creation of a ring that could last up to 100 million years.",R.drawable.funfact9));
        funfacts.add(new FunFacts("11. Sunsets on Mars are blue","During the Martian day the sky is pinkish-red, this is the opposite of the Earth’s skies.",R.drawable.funfact10));
